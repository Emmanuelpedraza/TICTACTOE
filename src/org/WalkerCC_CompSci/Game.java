...
public class Game {
    ...
    private org.WalkerCC_CompSci.Player player1;
    private org.WalkerCC_CompSci.Player player2;
    private boolean isComplete = false;

    public Game(){
        gameBoard = new GameBoard();
        player1 = new org.WalkerCC_CompSci.Player(Space.X, 1);
        player2 = new org.WalkerCC_CompSci.Player(Space.O, 2);
    }
